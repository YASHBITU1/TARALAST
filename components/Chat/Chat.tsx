import { IconClearAll, IconSettings ,IconStar } from '@tabler/icons-react';
import {
  MutableRefObject,
  memo,
  useCallback,
      ...
      {!(apiKey || serverSideApiKeyIsSet) ? (
        <div className="mx-auto flex h-full w-[300px] flex-col justify-center space-y-6 sm:w-[600px]">
          ...
          <div className="text-center text-lg text-black dark:text-white">
            <div className="mb-8">{`TARA serves as a valuable AI chatbot assistant.`}</div>
          ...
          >
            {selectedConversation?.messages.length === 0 ? (
              ...
              <>
                ...
                <div
                  className="h-[162px] dark:bg-[#34354]"
                  ref={messagesEndRef}
                />
              </>
            )}
