...
export const Key: FC<Props> = ({ apiKey, onApiKeyChange }) => {
  ...
  return isChanging ? (
    <div style={{visibility:'hidden'}} className="duration:200 flex w-full cursor-pointer items-center rounded-md py-3 px-3 transition-colors hover:bg-gray-500/10">
      <IconKey size={18} />
